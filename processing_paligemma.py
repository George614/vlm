...
def add_image_tokens_to_prompt(prefix_prompt, bos_token, image_seq_len, image_token):
    # see huggingface blog on paligemma
...
class PaliGemmaProcessor:
    ...
    def __init__(self, tokenizer, num_image_tokens: int, image_size: int) -> None:
        ...
        # we'll add the BOS and EOD tokens ourselves
    ...
    def __call__(
        ...
        # convert the list to numpy array of shape [batch_size, channel, height, weight]
        ...
        # returns teh input_ids and attention_mask as pytorch tensors
